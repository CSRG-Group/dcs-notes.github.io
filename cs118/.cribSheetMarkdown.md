...
- The `final` keyword denotes a property which is immutable, so it can only be assigned a value on initialisation, and never changed afterwards
...
- The "Exceptions hierarchy" (image credit [GeeksForGeeks](https://www.geeksforgeeks.org/exceptions-in-java/))
  ![exceptionsDiagram](C:\Users\egood\Desktop\dcs-notes.github.io\cs118\exceptionsDiagram.png)
